...
## Overview
Brief description of Azure Database for PostgreSQL/MySQL and its purpose in Azure.
...
- Azure subscription
- Azure CLI installed
- Basic understanding of open-source databases
...
az [service] create \
  --resource-group myRG \
  --name myazure-database-for-postgresql/mysql \
  --location eastus
```
