...
## Overview
Brief description of Role-Based Access Control (RBAC) and its purpose in Azure.
...
- Azure subscription
- Azure CLI installed
- Basic understanding of access control
...
az [service] create \
  --resource-group myRG \
  --name myrole-based-access-control-(rbac) \
  --location eastus
```
